...
const MODELOS: Modelo[] = [
  ...
  },
  {
    ...
    img: "/motos/showcase-classic-650-chrome.webp",
    bg: "hsl(0, 35%, 7%)",
    acento: "#E2231A",
    specs: [
      { valor: "648", unidad: "CC", label: "CILINDRADA" },
      { valor: "46", unidad: "HP", label: "POTENCIA" },
      { valor: "160", unidad: "KM/H", label: "VELOCIDAD" },
    ],
    hermanos: ["Classic 350", "Super Meteor 650", "Shotgun 650", "Bear 650"],
    precioDesde: "$ 6.799.900",
  },
  {
    id: "cyclone-ra2",
    marca: "Cyclone",
