...
const CATALOGO = [
  ...
  { id: "kw-superlight-200", marca: "Keeway", modelo: "Superlight 200", segmento: "Custom", cc: 200, precio_lista: 2_299_000, precio_bono: 1_999_900, bono_vence: null, img_local: "/motos/superlight200.png", usos: ["Ciudad", "Placer"], apta_principiante: true, destacado: false, orden: 12 },
  { id: "zt-zt350-t2", marca: "Zontes", modelo: "ZT350-T2", segmento: "Adventure", cc: 350, precio_lista: 4_390_000, precio_bono: null, bono_vence: null, img_local: "/motos/T2.350.png", usos: ["Ruta", "Ciudad", "Placer"], apta_principiante: false, destacado: false, orden: 13 },
  { id: "vg-525-dsx-m", marca: "Voge", modelo: "525 DSX M", segmento: "Adventure", cc: 525, precio_lista: 6_799_000, precio_bono: null, bono_vence: null, img_local: "/motos/525DSXM.png", usos: ["Ruta", "Off-road", "Placer"], apta_principiante: false, destacado: false, orden: 14 },
  { id: "vg-300-rally", marca: "Voge", modelo: "300 Rally", segmento: "Off-road", cc: 300, precio_lista: 3_299_000, precio_bono: null, bono_vence: null, img_local: "/motos/rally.png", usos: ["Off-road", "Ciudad"], apta_principiante: true, destacado: false, orden: 15 },
  { id: "cy-ra2", marca: "Cyclone", modelo: "RA2", segmento: "Naked", cc: 250, precio_lista: 2_899_900, precio_bono: 2_699_900, bono_vence: null, img_local: "/motos/RA2.png", usos: ["Ciudad", "Trabajo"], apta_principiante: true, destacado: false, orden: 16 },
];
